...
addEvent("tunrc_Stats.requireStats", true)
addEventHandler("tunrc_Stats.requireStats", root, function (name)
    triggerClientEvent(client, "tunrc_Stats.stats", root, name, getStats(name))
end)