...
local function createShader()
	...
	engineApplyShaderToWorldTexture(grunShader, "frontbump_color")
	engineApplyShaderToWorldTexture(shatShader, "frontbump_color")
	engineApplyShaderToWorldTexture(geneShader, "frontbump_color")
	engineApplyShaderToWorldTexture(grunShader, "rearbump_color")
	engineApplyShaderToWorldTexture(shatShader, "rearbump_color")
	engineApplyShaderToWorldTexture(geneShader, "rearbump_color")
	engineApplyShaderToWorldTexture(grunShader, "fenderleft_color")
	engineApplyShaderToWorldTexture(shatShader, "fenderleft_color")
	engineApplyShaderToWorldTexture(geneShader, "fenderleft_color")
	engineApplyShaderToWorldTexture(grunShader, "fenderright_color")
	engineApplyShaderToWorldTexture(shatShader, "fenderright_color")
	engineApplyShaderToWorldTexture(geneShader, "fenderright_color")
	engineApplyShaderToWorldTexture(grunShader, "sideskirt_color")
	engineApplyShaderToWorldTexture(shatShader, "sideskirt_color")
	engineApplyShaderToWorldTexture(geneShader, "sideskirt_color")
	engineApplyShaderToWorldTexture(grunShader, "rearfends_color")
	engineApplyShaderToWorldTexture(shatShader, "rearfends_color")
	engineApplyShaderToWorldTexture(geneShader, "rearfends_color")
	engineApplyShaderToWorldTexture(grunShader, "dops_color")
	engineApplyShaderToWorldTexture(shatShader, "dops_color")
	engineApplyShaderToWorldTexture(geneShader, "dops_color")
	engineApplyShaderToWorldTexture(grunShader, "lips_color")
	engineApplyShaderToWorldTexture(shatShader, "lips_color")
	engineApplyShaderToWorldTexture(geneShader, "lips_color")
	engineApplyShaderToWorldTexture(grunShader, "bonnet_color")
	engineApplyShaderToWorldTexture(shatShader, "bonnet_color")
	engineApplyShaderToWorldTexture(geneShader, "bonnet_color")
	engineApplyShaderToWorldTexture(grunShader, "frontfends_color")
	engineApplyShaderToWorldTexture(shatShader, "frontfends_color")
	engineApplyShaderToWorldTexture(geneShader, "frontfends_color")
	engineApplyShaderToWorldTexture(grunShader, "extraone_color")
	engineApplyShaderToWorldTexture(shatShader, "extraone_color")
	engineApplyShaderToWorldTexture(geneShader, "extraone_color")
	engineApplyShaderToWorldTexture(grunShader, "extratwo_color")
	engineApplyShaderToWorldTexture(shatShader, "extratwo_color")
	engineApplyShaderToWorldTexture(geneShader, "extratwo_color")
	engineApplyShaderToWorldTexture(grunShader, "extrathree_color")
	engineApplyShaderToWorldTexture(shatShader, "extrathree_color")
	engineApplyShaderToWorldTexture(geneShader, "extrathree_color")
	engineApplyShaderToWorldTexture(grunShader, "extrafour_color")
	engineApplyShaderToWorldTexture(shatShader, "extrafour_color")
	engineApplyShaderToWorldTexture(geneShader, "extrafour_color")
	engineApplyShaderToWorldTexture(grunShader, "extrafive_color")
	engineApplyShaderToWorldTexture(shatShader, "extrafive_color")
	engineApplyShaderToWorldTexture(geneShader, "extrafive_color")
...
addEventHandler("onClientResourceStart", resourceRoot, function ()
	setEnabled(exports.tunrc_Config:getProperty(CONFIG_PROPERTY_NAME))
end)
