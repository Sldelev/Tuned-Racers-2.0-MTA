...
function WetShadersC:constructor(parent)
	...
	self.wetRoadPuddlesTextures = {	"*freew*",
									...
									"ws_airpt_concrete",
									--irohazaka
									"image041b8e00_09325d50",
									"image041bbc00_09323250",
									"image0418ac00_09312ad0",
									"image0418bc00_09312150",
									"image09325e80_09326ed0",
									"image04174000_093253d0",
									"image04176000_093210d0",
									"image04178400_09311bd0",
									"image04178800_0931ef50",
									"image09313180_093135d0",
									--redring
									"1-4",
									"1-4y",
									"5-8",
	...
	self.wetRoadTextures = {		"crazy paving",
									...
									"sandnew_law",
									--irohazaka
									"image041b3000_092fb850",
									"04178000_092beed0",
									"0417a800_092f8d50",
									"image041c3400_092bf450",
									"image041c3800_093290d0",
									"image092f5b80_092f6bd0",
									"image092f8e80_092faed0",
									--redring
									"eb_m_grass_low",
									"kerb",
									"pol",
...
function WetShadersC:init()
	if (self:checkVersion()) then
		...
		self.wetRoadsShader = dxCreateShader("res/shaders/wetRoads.fx", 0, self.drawDistance, true, "world,object")
		self.wetRoadsWithPuddlesShader = dxCreateShader("res/shaders/wetRoadsWithPuddles.fx", 0, self.drawDistance, true, "world,object")
