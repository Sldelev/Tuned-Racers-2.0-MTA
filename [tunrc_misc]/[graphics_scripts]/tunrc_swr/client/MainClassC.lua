...
local Instance = nil
local CONFIG_PROPERTY_NAME = "graphics.wetroad"
...
addEventHandler("onClientResourceStart", resourceRoot, startSWR)
...
function setRain ( commandName )
	setRainLevel(0.1)
end    
addCommandHandler ( "setRain", setRain )

function resetRain ( commandName )
	resetRainLevel()
end    
addCommandHandler ( "resetRain", resetRain )