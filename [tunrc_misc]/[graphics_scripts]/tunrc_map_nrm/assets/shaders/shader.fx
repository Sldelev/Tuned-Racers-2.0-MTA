...
float4 ColorNormals = float4(1,1,1,1); // цвет нормалек
...
float4 PixelShaderFunction(PSInput PS) : COLOR0
{
    ...
    vReflection.x+= vFlakesSpecular.x * 0.1;
    vReflection.y+= vFlakesSpecular.y * 0.1;
	...
	finalColor.a = alphaCurrentTexture;
    return finalColor;
}
