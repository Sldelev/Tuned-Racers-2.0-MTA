...
addEventHandler("tunrc_Garage.saveCar", resourceRoot, function (garageVehicleIndex, tuning, stickers)
	...
	exports.tunrc_Core:updateVehicleTuning(vehicleTable._id, tuning, stickers)
end)
