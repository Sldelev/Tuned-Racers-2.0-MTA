...
function UpgradesMenu:init(position, rotation)
	self.super:init(position, rotation, Vector2(1.4, 1.33))
	self.headerHeight = 70
	self.headerText = exports.tunrc_Lang:getString("garage_tuning_config_upgrades")
	...
	local streetUpgradePrice = exports.tunrc_Shared:getTuningPrices("upgrade_price_street")
	local driftUpgradePrice = exports.tunrc_Shared:getTuningPrices("upgrade_price_drift")

	table.insert(self.buttons, {
		upgrade 	= "StreetHandling",
		name 		= exports.tunrc_Lang:getString("garage_tuning_config_street_upgrade"),
		description = exports.tunrc_Lang:getString("garage_tuning_config_street_description"),
		price 		= streetUpgradePrice,
		enabled 	= exports.tunrc_Vehicles:hasVehicleHandling(GarageCar.getName(), "street", 2)
	})

	if exports.tunrc_Vehicles:hasVehicleHandling(GarageCar.getName(), "drift") then
		table.insert(self.buttons, {
			upgrade 	= "DriftHandling",
			name 		= exports.tunrc_Lang:getString("garage_tuning_config_drift_upgrade"),
			description = exports.tunrc_Lang:getString("garage_tuning_config_drift_description"),
			price 		= driftUpgradePrice,
			enabled 	= exports.tunrc_Vehicles:hasVehicleHandling(GarageCar.getName(), "drift")
		})
	end
	if exports.tunrc_Vehicles:hasVehicleHandling(GarageCar.getName(), "offroad") then
		table.insert(self.buttons, {
			upgrade 	= "OffroadHandling",
			name 		= exports.tunrc_Lang:getString("garage_tuning_config_offroad_upgrade"),
			description = exports.tunrc_Lang:getString("garage_tuning_config_offroad_description"),
			price 		= driftUpgradePrice,
			enabled 	= exports.tunrc_Vehicles:hasVehicleHandling(GarageCar.getName(), "offroad")
		})
	end
	self.activeButton = 1
	self.price = false
