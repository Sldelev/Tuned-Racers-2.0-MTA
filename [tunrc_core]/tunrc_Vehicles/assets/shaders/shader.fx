...
float normalFactor = 0.1; // насколько сильно давить нормали (от 0 до 1)
...
float4 ColorFlakes = float4(0.15,0.15,0.15,1); // это я накинул доп освещение, если тебе не нужно выкинь
