...
MAX_DISTANCE_FROM_PLAYER = 80000
...
function getCameraFov()
	return	cameraFOVActual
end

function getCameraRoll()
	return	cameraRollActual
end
...
local function update(dt)
	...
	if isSmoothMovementEnabled then
		...
		actualRotationY = actualRotationY + exports.tunrc_Utils:differenceBetweenAnglesRadians(actualRotationY, rotationY) * dt * SMOOTH_LOOK_SPEED
...
function enablePhotoMode()
	if photoModeEnabled or localPlayer:getData("tunrc_Core.state") then
		return false
	end
	...
	exports.tunrc_Nametags:setVisible(false)
...
function disablePhotoMode()
	...
	--exports.tunrc_Time:restoreTime()
