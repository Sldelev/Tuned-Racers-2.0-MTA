addEvent("tunrc_Houses.house_enter", true)
addEventHandler("tunrc_Houses.house_enter", resourceRoot, function (markerId)
...
function removePlayerFromHouse(player, houseMarkerId)
	...
	triggerClientEvent(player, "tunrc_Houses.kickedFromHouse", resourceRoot)
end

addEvent("tunrc_Houses.house_exit", true)
addEventHandler("tunrc_Houses.house_exit", resourceRoot, function (markerId)
	removePlayerFromHouse(client, markerId)
end)


addEvent("tunrc_Houses.knock", true)
addEventHandler("tunrc_Houses.knock", resourceRoot, function (houseId)
	triggerClientEvent("tunrc_Houses.knock", client, houseId)
end)

addEvent("tunrc_Houses.kickPlayers", true)
addEventHandler("tunrc_Houses.kickPlayers", resourceRoot, function ()
