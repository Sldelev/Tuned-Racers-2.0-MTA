...
local function update(deltaTime)	
	...
	if localPlayer.vehicle.onGround then
		...
		speedSquared = velocity:getSquaredLength()
	...
	-- Обновление камеры
	Camera.setMatrix(cameraPos, cameraLook, cameraRoll - cameraShake.x * 50 , targetCameraFov)
end
...
function CockpitView.start()
	...
	localPlayer:setData("tunrc_HUD.hideSpeedometer", true, false)
	skipFrame = true
	return true
end
...
function CockpitView.stop()
	...
	localPlayer:setData("tunrc_HUD.hideSpeedometer", false, false)
end