...
addEvent("tunrc_Time.requireTime", true)
addEventHandler("tunrc_Time.requireTime", resourceRoot, function ()
	triggerClientEvent(client, "tunrc_Time.updateTime", resourceRoot, serverTime, MINUTE_DURATION)
end)
...
function setServerTime(hh, mm)
	...
	triggerClientEvent("tunrc_Time.updateTime", resourceRoot, serverTime, MINUTE_DURATION)
	return true
end