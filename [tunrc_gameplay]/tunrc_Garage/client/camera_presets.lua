...
-- Передний бампер при покупке
cameraPresets.previewFrontFendsDops = {
	targetPosition = Vector3(0, 0, 0),
	rotationHorizontal = -50,
	rotationVertical = 10,
	distance = 8,
...
-- Передний номер при покупке
cameraPresets.previewFrontnumber = {
	targetPosition = Vector3(0, 0, 0),
	rotationHorizontal = -50,
	rotationVertical = 10,
	distance = 8,
...
-- Передний шильдик при покупке
cameraPresets.previewFbadge = {
	targetPosition = Vector3(0, 0, 0),
	rotationHorizontal = -50,
	rotationVertical = 10,
	distance = 8,
...
-- Сплитеры при покупке
cameraPresets.previewLips = {
	targetPosition = Vector3(0, 0, 0),
	rotationHorizontal = -50,
	rotationVertical = 10,
	distance = 8,
...
-- Задний бампер при покупке
cameraPresets.previewRearnumber = {
	targetPosition = Vector3(0, 0, 0),
	rotationHorizontal = -180,
	rotationVertical = 10,
	distance = 8,
...
-- Диффузоры при покупке
cameraPresets.previewDiffusors = {
	targetPosition = Vector3(0, 0, 0),
	rotationHorizontal = -180,
	rotationVertical = 10,
	distance = 8,
...
-- Колёса при покупке
cameraPresets.previewWheelsCaliperF = {
	targetPosition = "wheel_rf_dummy",
	rotationHorizontal = -70,
	rotationVertical = 5,
	distance = 7,
...
-- Задние колёса при покупке
cameraPresets.previewWheelsCaliperR = {
	targetPosition = "wheel_rb_dummy",
	rotationHorizontal = -70,
	rotationVertical = 5,
	distance = 7,
...
-- Колёса при покупке
cameraPresets.previewCalipersRotationF = {
	targetPosition = "wheel_rf_dummy",
	rotationHorizontal = -70,
	rotationVertical = 5,
	distance = 7,
...
-- Задние колёса при покупке
cameraPresets.previewCalipersRotationR = {
	targetPosition = "wheel_rb_dummy",
	rotationHorizontal = -70,
	rotationVertical = 5,
	distance = 7,
...
-- Колёса при покупке
cameraPresets.previewWheelsTiresF = {
	targetPosition = "wheel_rf_dummy",
	rotationHorizontal = -70,
	rotationVertical = 5,
	distance = 7,
...
-- Задние колёса при покупке
cameraPresets.previewWheelsTiresR = {
	targetPosition = "wheel_rb_dummy",
	rotationHorizontal = -70,
	rotationVertical = 5,
	distance = 7,
...
cameraPresets.previewWheelsSizeF = {
	targetPosition = "wheel_rf_dummy",
	rotationHorizontal = -70,
	rotationVertical = 5,
	distance = 7,
...
cameraPresets.previewWheelsSizeR = {
	targetPosition = "wheel_rb_dummy",
	rotationHorizontal = -70,
	rotationVertical = 5,
	distance = 7,
...
-- Передние фендеры при покупке
cameraPresets.previewFrontFendsR = {
	targetPosition = Vector3(0, 0, 0),
	rotationHorizontal = -50,
	rotationVertical = 10,
	distance = 8,
...
-- Передние фендеры при покупке
cameraPresets.previewFrontFendsL = {
	targetPosition = Vector3(0, 0.5, -0.2),
	rotationHorizontal = 20,
	rotationVertical = 0,
	distance = 4.5,
...
-- ручники при покупке
cameraPresets.previewHandBrakes = {
...
--  ручка кпп при покупке
cameraPresets.previewGearShifts = {
	targetPosition = "Int",
	rotationHorizontal = -110,
	rotationVertical = 10,
	distance = 1,
	FOV = 75,
	roll = 0
...
-- Асосисары при покупке
cameraPresets.previewAcces = {
	targetPosition = Vector3(0, 0, 0),
	rotationHorizontal = -50,
	rotationVertical = 10,
	distance = 8,
...
-- Задние фары при покупке
cameraPresets.previewRearLightR = {
	targetPosition = Vector3(0, 0, 0),
	rotationHorizontal = -180,
	rotationVertical = 10,
	distance = 8,
...
-- Задние фары при покупке
cameraPresets.previewRearLightL = {
	targetPosition = Vector3(0, 0, 0),
	rotationHorizontal = -180,
	rotationVertical = 10,
	distance = 8,
...
-- Поворотники при покупке
cameraPresets.previewSideLights = {
	targetPosition = Vector3(0, 0, 0),
	rotationHorizontal = -50,
	rotationVertical = 10,
	distance = 8,
...
-- Передние фары справа при покупке
cameraPresets.previewFaraR = {
	targetPosition = Vector3(0, 0, 0),
	rotationHorizontal = -50,
	rotationVertical = 10,
	distance = 8,
...
-- Передние фары слева при покупке
cameraPresets.previewFaraL = {
	targetPosition = Vector3(0, 0, 0),
	rotationHorizontal = -50,
	rotationVertical = 10,
	distance = 8,
...
-- Дополнительные элементы при покупке
cameraPresets.previewDops = {
	targetPosition = Vector3(0, 0, 0),
	rotationHorizontal = -50,
	rotationVertical = 10,
	distance = 8,
...
cameraPresets.selectingSpecularColor = {
	targetPosition = Vector3(0, 0, 0),
	rotationHorizontal = -50,
	rotationVertical = 10,
	distance = 8,
...
cameraPresets.selectingChromePower = {
	targetPosition = Vector3(0, 0, 0),
	rotationHorizontal = -50,
	rotationVertical = 10,
	distance = 8,
...
cameraPresets.selectingWheelsSpecularF = {
	targetPosition = "wheel_rf_dummy",
	rotationHorizontal = -70,
	rotationVertical = 5,
	distance = 7,
...
cameraPresets.selectingWheelsChromeF = {
	targetPosition = "wheel_rf_dummy",
	rotationHorizontal = -70,
	rotationVertical = 5,
	distance = 7,
...
-- Покраска передних болтов при покупке
cameraPresets.selectingCalipersColorF = {
	targetPosition = "wheel_rf_dummy",
	rotationHorizontal = -70,
	rotationVertical = 5,
	distance = 7,
...
cameraPresets.selectingWheelsSpecularR = {
	targetPosition = "wheel_rb_dummy",
	rotationHorizontal = -70,
	rotationVertical = 5,
	distance = 7,
...
cameraPresets.selectingWheelsChromeR = {
	targetPosition = "wheel_rb_dummy",
	rotationHorizontal = -70,
	rotationVertical = 5,
	distance = 7,
...
-- Покраска передних болтов при покупке
cameraPresets.selectingCalipersColorR = {
	targetPosition = "wheel_rb_dummy",
	rotationHorizontal = -70,
	rotationVertical = 5,
	distance = 7,
