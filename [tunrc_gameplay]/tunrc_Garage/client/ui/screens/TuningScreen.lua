...
function TuningScreen:init(item)
	...
	self.panel = TuningPanel({
		{icon = Assets.textures.tuningComponentsIcon, text = exports.tunrc_Lang:getString("garage_menu_customize_components")},
		{icon = Assets.textures.tuningColorIcon,      text = exports.tunrc_Lang:getString("garage_menu_customize_paint")},
		{icon = Assets.textures.tuningVinylsIcon,     text = exports.tunrc_Lang:getString("garage_menu_customize_stickers")},
		{icon = Assets.textures.tuningSettingsIcon,   text = exports.tunrc_Lang:getString("garage_menu_customize_config")},
	}, true)
