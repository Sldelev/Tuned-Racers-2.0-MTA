...
local function draw()
    ...
    dxDrawText(exports.tunrc_Lang:getString("race_finish_race_button"), x, y, x + panelWidth, y + buttonsHeight, tocolor(255, 255, 255), 1, itemFont, "center", "center")
    dxSetRenderTarget()
end
...
function FinishScreen.show(gridType)
    ...
    FinishScreen.start()
    crowdSound = exports.tunrc_Sounds:playSound("crowd.wav")
end
