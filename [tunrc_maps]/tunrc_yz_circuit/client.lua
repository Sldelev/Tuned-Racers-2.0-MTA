yz_circuit = createColCuboid ( -8100, -1700, 4100, 400, 450, 200.0 )
...
setTimer(function ()
    if ( theElement == localPlayer ) then -- Checks whether the entering element is in the same dimension as the collision shape.
        txd = engineLoadTXD ( "yz_circuit.txd" )

engineImportTXD ( txd, 1700)
engineImportTXD ( txd, 1701	)
engineImportTXD ( txd, 1702	)

dff = engineLoadDFF("yz1.dff",0)
dff1 = engineLoadDFF("yz2.dff",0)
dff2 = engineLoadDFF("yz3.dff",0)

engineReplaceModel ( dff, 1700)
engineReplaceModel ( dff1,1701)
engineReplaceModel ( dff2,1702)

col = engineLoadCOL("yz1.col",0)
col1 = engineLoadCOL("yz2.col",0)
col2 = engineLoadCOL("yz3.col",0)
...
addEventHandler ("onClientColShapeHit", yz_circuit, dimensionChecker)
...
addEventHandler("onClientColShapeLeave", yz_circuit, onClientColShapeLeave)	