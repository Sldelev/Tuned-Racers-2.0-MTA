...
function Widget.create(properties)
	...
	local widget = {}
	widget.x = exports.tunrc_Utils:defaultValue(properties.x, 0)
	widget.y = exports.tunrc_Utils:defaultValue(properties.y, 0)
	widget.width = exports.tunrc_Utils:defaultValue(properties.width, 0)
	widget.height = exports.tunrc_Utils:defaultValue(properties.height, 0)
	widget.parent = nil
	widget.children = {}
	widget.color = exports.tunrc_Utils:defaultValue(properties.color, Colors.color("white"))
	widget.visible = exports.tunrc_Utils:defaultValue(properties.visible, true)
	widget.text = exports.tunrc_Utils:defaultValue(properties.text, "")
	widget.locale = exports.tunrc_Utils:defaultValue(properties.locale, false)
	return widget
end
