...
function setTheme(theme)
	return exports.tunrc_Config:setProperty("ui.theme", theme)
end
...
local publicPropertiesList = {
	-- Base
	"x", "y", "width", "height", "radius", "color", "visible", "text",
	-- TextField
...
for i, name in ipairs(publicPropertiesList) do
	local capitalizedName = exports.tunrc_Utils:capitalizeString(name)
