...
local THEME_NAMES = {"purple", "blue", "red", "green", "orange", "light_pink", "light_brown", "black"}
...
function Colors.setTheme(name)
	...
	Render.updateTheme()
	triggerEvent("tunrc_UI.updateTheme", resourceRoot)
	return true
end
...
local function loadThemes()
	...
	local theme = exports.tunrc_Config:getProperty("ui.theme")
	if theme then
