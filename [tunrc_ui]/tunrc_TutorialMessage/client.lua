...
function showMessage(title, text, ...)
	...
	infoFont = exports.tunrc_Assets:createFont("Roboto-Regular.ttf", 18)
	infoFontHeight = dxGetFontHeight(1, infoFont)
	infoIconSize = infoFontHeight * 0.7
	
	textLines = {}
	closeText = "BACKSPACE - " .. utf8.lower(tostring(exports.tunrc_Lang:getString("message_box_close")))
	local formatArgs = {...}
	local themeColorHEX = exports.tunrc_Utils:RGBToHex(exports.tunrc_UI:getThemeColor())
